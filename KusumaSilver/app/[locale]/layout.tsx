    ...
    <html lang={locale} className={`${cormorant.variable} ${jakarta.variable}`}>
      <body className="font-body bg-paper text-ink antialiased">
        <CurrencyProvider>
          ...
          {/* Floating WhatsApp button — 54px sharp square per design */}
          <a
            href={waLink}
            target="_blank"
            rel="noopener noreferrer"
            className="fixed bottom-6 right-6 z-[60] flex h-[54px] w-[54px] items-center justify-center border border-paper bg-ink transition-colors hover:bg-accent"
            aria-label="WhatsApp"
          >
            <svg viewBox="0 0 24 24" className="h-[26px] w-[26px] fill-paper">
